 ...
 */
final class Version20211026080712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ad (id INT AUTO_INCREMENT NOT NULL, marketer_id INT NOT NULL, title VARCHAR(50) NOT NULL, date_update DATE NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_77E0ED58DDEFF2BE (marketer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE adopting (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dog (id INT AUTO_INCREMENT NOT NULL, ad_id INT DEFAULT NULL, history VARCHAR(255) DEFAULT NULL, lof TINYINT(1) NOT NULL, description VARCHAR(255) NOT NULL, animals_friendly TINYINT(1) NOT NULL, INDEX IDX_812C397D4F34D596 (ad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE marketer (id INT AUTO_INCREMENT NOT NULL, type_marketer_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_52848F8B96F6252F (type_marketer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
